...
##############################################
    ...
    psedit "$demoPath\Project 1 - PowerShell Project\PrepDemo.ps1"
    ...
    ##############################################
        ...
        ## CALLOUT: MockModules
        ######################
        psedit "$demoPath\Callouts\MockModules.ps1"
        ...
        ## CALLOUT: FakeData
        ###############
        psedit "$demoPath\Callouts\FakeData.ps1"
...
##############################################
    ...
    start 'https://github.com/adb!ertram/TestDomainCreator'
